...
type HelloWorldServiceClient interface {
	SayHello(ctx context.Context, in *HelloWorldRequest, opts ...grpc.CallOption) (*WebResponse, error)
}
...
func (c *helloWorldServiceClient) SayHello(ctx context.Context, in *HelloWorldRequest, opts ...grpc.CallOption) (*WebResponse, error) {
	out := new(WebResponse)
...
type HelloWorldServiceServer interface {
	SayHello(context.Context, *HelloWorldRequest) (*WebResponse, error)
...
func (UnimplementedHelloWorldServiceServer) SayHello(context.Context, *HelloWorldRequest) (*WebResponse, error) {
